...
const calculateFacetScore = (answers, dimension, facetName) => {
...
const calculateScores = (answers) => {
  ...
  scores.honesty_humility = calculateDimensionScore(answers, 'H');
  scores.emotionality = calculateDimensionScore(answers, 'E');
  scores.extraversion = calculateDimensionScore(answers, 'X');
  scores.agreeableness = calculateDimensionScore(answers, 'A');
  scores.conscientiousness = calculateDimensionScore(answers, 'C');
  scores.openness = calculateDimensionScore(answers, 'O');
  scores.altruism = calculateDimensionScore(answers, 'I');
...
module.exports = {
  testName: 'HEXACO Personality Inventory',
  dimensions: HEXACO_DIMENSIONS,
  calculateScores,
  reverseScore,
  calculateFacetScore,
